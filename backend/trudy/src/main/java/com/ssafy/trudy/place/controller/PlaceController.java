...
public class PlaceController {
    ...
    @GetMapping("/filter")
    @ResponseBody
    public List<PlaceDto> findPlaceListByCategory(@RequestParam String offset, @RequestParam String limit, @RequestParam String areaSigun, @RequestParam String contentTypeIdd) {
        return placeService.findPlaceListByCategory(offset, limit, areaSigun, contentTypeIdd);
    }
