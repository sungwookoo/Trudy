            ...
            return (
              <>
                {authCtx.loggedInfo.uid !== guide.id ? (
                  <div
                    className="w-full bg-slate-100 rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row shadow-lg"
                    key={i}
                    onClick={() => {
                  ...
                  >
                    ...
                    <div className="w-full md:w-3/5 text-left p-4 md:p-4 space-y-2">
                      ...
                      <p className="text-2xl text-gray-400 font-normal">areacode : {guide.areacode}</p>
