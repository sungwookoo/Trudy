      ...
      <div ref={outerDivRef} className="outer">
        ...
        <div className="landing-container">
          ...
          <div className="landing1">
            ...
            <div className="trudy-header1">Trudy</div>
            <div className="trudy-detail1">Travel deeper see more with local expertise</div>
          </div>
          <div className="divider"></div>
          {/* 랜딩 2번째 화면 */}
          <div className="landing2">
            <div className="landing-image-container2"></div>
            <div className="trudy-header2">Traveling to Korea?</div>
            <div className="trudy-detail2">Search hidden gems only locals can provide!</div>
          </div>
          <div className="divider"></div>
          {/* 랜딩 3번째 화면 */}
